...
Venezuela, using (along with custom scripts and tools) [OONI
Probe](https://ooni.org/install/) and [OONI
data](https://ooni.org/data/).

## Arthit Suriyawongkul, [Thai Netizen Network](https://thainetizen.org/)

Arthit works with the [Thai Netizen
Network](https://thainetizen.org/), a leading non-profit
...
Azerbaijan, Caucasus, and Turkey. In 2019, she launched [Azerbaijan
Internet Watch (AIW)](https://www.az-netwatch.org/), an
...
able to [publish several
reports](https://ooni.org/partners/azerbaijan-internet-watch/)
...
Davide on measuring the [blocking of the Gutenberg book publishing
website](https://ooni.org/post/2021-italy-blocks-gutenberg-book-publishing-website/)
in Italy.

## Felicia Anthonio, [Access Now](https://www.accessnow.org/)

[Felicia](https://www.accessnow.org/profile/felicia/) is
the Campaign Manager of Access Now's [#KeepItOn
campaign](https://www.accessnow.org/keepiton/): a global
...
Since 2016, OONI has [worked
closely](https://ooni.org/partners/access-now/) with the
...
which often [trigger new censorship
events](https://ooni.org/reports/)) and on providing
...
## Igor Valentinovich, [Netalitica](https://netalitica.com/)
...
Based on OONI data, Sinar Project created the [Southeast Asia
Censorship
Dashboard](https://censorship.sinarproject.org/#/summary/2020)
...
[Ksenia](https://twitter.com/edok_lotosov) is a researcher
engaged in multiple projects. Her primary field of research is sociology
...
In 2018, Ksenia collaborated with Igor Valentinovich on analyzing OONI
data to [investigate and compare internet
...
[Vianney](https://affcameroon.defyhatenow.org/member/ndum-vianney-forewah-digital-rights-activist/) is a digital rights activist and Executive Director of Community Participation in Sustainable Development (COMPSUDEV), a non-profit association in Cameroon that sets out to empower youths and communities through sustainable livelihood programs in the domain of digital rights, digital security, ICT and Open Access to the internet. 

We have [worked
together](https://ooni.org/partners/compsudev/) since 2019
...
As part of our [10th Ooniversary
Events](https://ooni.org/post/10th-ooniversary-events/), we
...
you can [get
involved](https://ooni.org/support/faq#how-can-i-get-involved)!
