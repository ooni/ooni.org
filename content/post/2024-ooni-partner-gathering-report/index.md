...
{{< oonibtn href="/documents/OONI-Partner-Gathering-Agenda.pdf" text="Download OONI Partner Gathering Agenda in PDF" >}}
...
| Session                                                                                             | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| --------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Opening Plenary                                                                                     | A welcome by the OONI team. An overview of the agenda, participation guidelines, Code of Conduct, and logistics.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| Introduction to Internet censorship (slides)                                                        | How is Internet censorship implemented? Why measure networks? This session (facilitated by OONI) shared knowledge on how Internet censorship is technically implemented, as well as key concepts that are useful for understanding and interpreting OONI data.                                                                                                                                                                                                                                                                                                                                                              |
| Measuring Internet connectivity shutdowns with IODA (slides)                                        | Interested in tracking Internet connectivity shutdowns? This session (facilitated by [IODA](https://ioda.inetintel.cc.gatech.edu/)) shared skills and knowledge on using the Internet Outage Detection and Analysis (IODA) platform which measures Internet connectivity shutdowns around the world in near real-time.                                                                                                                                                                                                                                                                                                      |
| OONI: Brief History & Future Goals (slides)                                                         | Presentation by OONI, providing a brief overview of OONI’s history, future goals, and upcoming projects.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
Beyond the 20 sessions included in the official agenda, the OONI Partner Gathering 2024 also included 5 additional unconference style sessions, proposed by participants during the event.
