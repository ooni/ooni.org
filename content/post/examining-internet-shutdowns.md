---
title: "Examining internet shutdowns through public data sources"
...
tests that are designed to examine internet shutdowns, when the internet as a
whole is rendered inaccessible within a location.

Over the last months we received many reports relating to internet shutdowns in
...
asserting that an internet shutdown had occurred just because we stopped
...
course, the country where an internet shutdown has been reported), or that they
...
also be useful when examining internet shutdowns. BGP data aggregated by
...
time. If a country-wide internet shutdown has occurred, we would expect to see
almost no internet traffic origination from a country during the reported period
of a shutdown. This, for example, was evident in Ethiopia in August 2016, when
an internet shutdown was [reported](http://www.bbc.com/news/world-africa-36940906) in the middle of political protests.
...
between 6th to 8th August, confirming that an internet shutdown occurred.
...
between 30th November to 2nd December, when an internet shutdown was
...
a country’s prefixes are withdrawn when an internet shutdown is being reported.
...
internet shutdown occurred during that period, as inferred through [Google traffic data](https://www.google.com/transparencyreport/traffic/explorer/?r=GM&l=WEBSEARCH&csd=1479483000000&ced=1480692600000).

# Cross-referencing data sources

Internet shutdowns might not always occur across all networks on a country-wide
...
cross-referencing data sources as part of an examination of internet shutdowns
...
internet shutdown if there is normal usage of the [Tor network](https://www.torproject.org/) during a reported shutdown. If, however,
...
shutdown in a country, Google traffic data does not show a clear shutdown, but
...
specific dates of a reported internet shutdown.
...
2016 when an internet shutdown was reported in the country.
