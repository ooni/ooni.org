...
Мы публикуем CSV-файл[\[a\]](/#cmnt1), в котором перечислены все 494 домена, которые заблокированы в России на основании данных OONI. Мы также публикуем CSV-файл[\[b\]](/#cmnt2), в котором перечислены все соответствующие этим доменам заблокированные URL-адреса. Оба файла содержат ссылки на соответствующие измерения OONI для каждого домена/URL, где доступны необработанные данные (показывающие блокировки).
...
Мы обнаружили 48 заблокированных доменов (блокировки подтвержденные данными OONI), которые не включены в [официальный реестр](https://reestr.rublacklist.net/en/) блокировок России. Список этих 48 доменов (вместе с соответствующими измерениями OONI) доступен в этом CSV[\[c\]](/#cmnt3).
