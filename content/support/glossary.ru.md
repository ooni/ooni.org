...
sections:
  - heading: 
    items:
      ...
      - q: Инструменты обхода блокировок
        a: |
      ...
      - q: Конвейер обработки данных (Data processing pipeline)
        a: |
      ...
      - q: Ложноположительный результат
        a: |
      ...
      - q: Прозрачный прокси-сервер HTTP
        a: |
      ...
      - q: Мгновенный обмен сообщениями
        a: |
