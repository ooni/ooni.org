...
sections:
  - heading: Про OONI
    items:
      ...
      - q: Зачем нужно измерять интернет-цензуру?
        a: |
      ...
      - q: Какое отношение имеет OONI к проекту Tor?
        a: |
      ...
      - q: Какой юридический статус у OONI?
        a: |
      ...
      - q: Как я могу помочь?
        a: |
          ...
          * **[Переводите приложения OONI Probe](https://explore.transifex.com/otf/ooniprobe/)**. [Переводя приложения OONI Probe](https://github.com/ooni/translations/blob/master/Guidelines%20for%20OONI%20Probe.md), вы даете возможность большему числу людей измерять уровень цензуры в интернете.

          * **[Переведите OONI Explorer](https://explore.transifex.com/otf/ooni-explorer/)**. [Переводя OONI Explorer](https://github.com/ooni/translations/blob/master/Guidelines%20for%20OONI%20Explorer.md), вы даете возможность большему числу людей получить доступ к данным об интернет-цензуре.
  ...
  - heading: OONI Probe
    items:
      ...
      - q: В моей стране нет цензуры. Зачем мне использовать OONI Probe?
        a: |
      ...
      - q: Как тесты OONI Probe измеряют интернет-цензуру?
        a: |
      ...
      - q: Я не технарь. Получится ли у меня разобраться в OONI Probe?
        a: |
      ...
      - q: Как мне запустить OONI Probe?
        a: |
      ...
      - q: Я запустил(а) OONI Probe. Нужно ли мне отправить вам результаты?
        a: |
      ...
      - q: Как часто мне необходимо запускать OONI Probe?
        a: |
      ...
      - q: Как проводить автоматическое тестирование OONI Probe?
        a: |
      ...
      - q: Как долго мне необходимо проводить тесты OONI Probe?
        a: |
      ...
      - q: Я обнаружил(а) заблокированный сайт. Как я могу обойти блокировку?
        a: |
      ...
      - q: OONI Probe обнаружил middlebox в моей сети. Означает ли это, что за мной следят?
        a: |
      ...
      - q: Могу ли я измерить интернет-цензуру удаленно из другой страны?
        a: |
      ...
      - q: Какие типы данных собирает OONI Probe?
        a: |
      ...
      - q: Как я могу отказаться от отправки результатов измерений OONI?
        a: |
      ...
      - q: Какие риски я могу ожидать от использования OONI Probe?
        a: |
      ...
      - q: Каким образом я могу уменьшить риски, связанные с использованием OONI Probe?
        a: |
      ...
      - q: Можно ли запустить OONI Probe через VPN?
        a: |
      ...
      - q: Может ли OONI предоставить юридическую консультацию?
        a: |
  ...
  - heading: Тестирование сайтов
    items:
      - q: Какие сайты я буду проверять на цензуру с помощью OONI Probe?
        a: |
      ...
      - q: Почему мобильное приложение OONI Probe не тестирует все сайты в списках для тестирования?
        a: |
      ...
      - q: Как изменить продолжительность тестирования в мобильном приложении OONI Probe, чтобы протестировать больше сайтов?
        a: |
      ...
      - q: Как я могу найти список для тестирования в моей стране?
        a: |
      ...
      - q: Почему я не могу найти список для тестирования в моей стране?
        a: |
      ...
      - q: Кто решает, какие сайты будут включены в списки тестирования?
        a: |
      ...
      - q: Как я могу внести свой вклад в списки для тестирования?
        a: |
      ...
      - q: Я не являюсь пользователем Github, но все же хотел(а) бы добавить новые URL-адреса для тестирования. Как я могу это сделать?
        a: |
      ...
      - q: В чем разница между списком для тестирования и блок-листом?
        a: |
      ...
      - q: Какие типы сайтов будет проверять OONI Probe?
        a: |
      ...
      - q: Как мне выбрать, какие типы сайтов тестировать?
        a: |
      ...
      - q: Как выбрать сайты для тестирования?
        a: |
      ...
      - q: Как протестировать собственный список URL-адресов?
        a: |
  ...
  - heading: Данные OONI
    items:
      ...
      - q: Почему OONI публикует данные?
        a: |
      ...
      - q: Как я могу интерпретировать данные OONI?
        a: |
      ...
      - q: Как я могу получить и проанализировать данные OONI?
        a: |
  ...
  - heading: OONI Explorer
    items:
      ...
      - q: Как я могу обнаружить заблокированные сайты с помощью OONI Explorer?
        a: |
      ...
      - q: Как я могу получить доступ к измерениям?
        a: |
      ...
      - q: Как я могу найти данные OONI через OONI Explorer?
        a: |
      ...
      - q: Как найти «доказательства интернет-цензуры» в измерении?
        a: |
          ...
          * Основываясь на нашей текущей эвристике, мы автоматически подтверждаем цензуру в интернете, только если провайдер предоставляет страницу блокировки для сайта или если разрешение DNS возвращает IP, связанный с цензурой.
          ...
          разработчиков.
      - q: Как обнаружить сайты заблокированные в моей стране?
        a: |
      ...
      - q: Как я могу проверить, заблокирован ли определенный сайт?
        a: |
      ...
      - q: Почему я не могу найти результаты для определенного сайта?
        a: |
      ...
      - q: Как я могу проверить блокировку сайтов за определенный период времени?
        a: |
      ...
      - q: Что вы подразумеваете под «Подтвержденными»?
        a: |
      ...
      - q: Я знаю много других сайтов, которые заблокированы. Почему OONI Explorer не показывает их, когда я выбираю «Подтвержденные»?
        a: |
      ...
      - q: Почему OONI подтверждает цензуру, когда показывается страница блокировки?
        a: |
      ...
      - q: Почему OONI не подтверждает другие случаи интернет-цензуры (помимо страниц блокировки)?
        a: |
      ...
      - q: Что вы имеете в виду под «аномалиями»?
        a: |
      ...
      - q: Почему OONI Explorer сообщает, что сайт или приложение, к которому я могу получить доступ, заблокирован в моей стране?
        a: |
      ...
      - q: Что такое ложноположительные результаты?
        a: |
      ...
      - q: Почему случаются ложноположительные результаты?
        a: |
      ...
      - q: Как можно отличить ложноположительные результаты?
        a: |
      ...
      - q: Как я могу узнать результаты других тестов OONI Probe?
        a: |
          ...
          Пожалуйста, интерпретируйте «аномальные» результаты с осторожностью, так как они могут содержать ложноположительные результаты.
      - q: Почему у моей страны нет недавних измерений в OONI Explorer?
        a: |
