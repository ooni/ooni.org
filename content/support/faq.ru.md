...
Если есть другие вопросы, на которые вы хотели бы получить ответ, то пожалуйста, [свяжитесь с
нами](https://ooni.org/about/#contact).
...
* [OONI Probe](#ooni-probe)
    ...
    * [Что делают тесты OONI Probe?](#что-дают-тесты-ooni-probe)

    * [Как тесты OONI Probe измеряют интернет-цензуру?](#как-тесты-ooni-probe-измеряют-интернет-цензуру)

    * [Я не технарь. У меня получится разобраться в OONI Probe?](#я-не-технарь-у-меня-получится-разобраться-в-ooni-probe)

    * [Как мне запустить OONI Probe?](#как-мне-запустить-ooni-probe)

    * [Я запустил(а) OONI Probe. Нужно ли мне отправить вам результаты?](#я-запустил(а)-ooni-probe-нужно-ли-мне-отправить-вам-результаты)
    ...
    * [Я обнаружил(а) заблокированный сайт. Как я могу обойти блокировку?](#я-обнаружил(а)-заблокированный-сайт-как-я-могу-обойти-блокировку)
...
* [Тестирование сайтов](#тестирование-сайтов)
    ...
    * [Я не являюсь пользователем Github, но все же хотел бы добавить новые URL-адреса для тестирования. Как я могу это сделать?](#я-не-являюсь-пользователем-github-но-все-же-хотел-бы-добавить-новые-url-для-тестирования-как-я-могу-это-сделать)
    ...
    * [Как мне выбрать, какие типы сайтов тестировать?](#как-мне-выбрать-какие-сайты-тестировать)
...
* [OONI Explorer](#ooni-explorer)
    ...
    * [Почему OONI не подтверждает другие случаи интернет-цензуры (помимо блокировки страниц)?](#почему-ooni-не-подтверждает-другие-случаи-интернет-цензуры-помимо-блокировки-страниц)
...
### Я не технарь. У меня получится разобраться в OONI Probe?
...
Чтобы узнать больше о потенциальных рисках, связанных с использованием OONI Probe, пожалуйста, ознакомьтесь с нашей документацией: https://ooni.org/about/risks/.
...
Тем не менее, мы делимся некоторыми вопросами, которые вы можете задать своим юристам в связи с использованием OONI Probe: https://ooni.org/about/risks/#seeking-legal-advice.
...
### Я не являюсь пользователем Github, но все же хотел бы добавить новые URL-адреса для тестирования. Как я могу это сделать?
...
### Почему OONI не подтверждает другие случаи интернет-цензуры (помимо блокировки страниц)?
