...
sections:
  - heading: 
    items:
      ...
      - q: Herramientas para evadir la censura
        a: |
      ...
      - q: Canal de procesamiento de datos
        a: |
      ...
      - q: Raspberry Pi o placa de micro ordenador
        a: |
