...
sections:
  - heading: Về OONI
    items:
      ...
      - q: Tại sao đo lường việc kiểm duyệt internet?
        a: |
      ...
      - q: OONI được tài trợ thế nào?
        a: |
          ...
          Trong một thời gian dài [Open Technology Fund (OTF)](https://www.opentech.fund/) là người tài trợ chính cho chúng tôi, nguyên thủy [hỗ trợ cho các hoạt động đầu tiên của OONI vào năm 2012](https://www.opentech.fund/results/supported-projects/ooni-open-observatory-of-network-interference/).
      ...
      - q: OONI liên hệ thế nào với đề án Tor?
        a: |
  ...
  - heading: OONI Probe
    items:
      ...
      - q: Quốc gia của tôi không có chuyện kiểm duyệt. Tại sao phải chạy OONI Probe?
        a: |
      ...
      - q: Kiểm tra của OONI Probe làm những việc gì?
        a: |
      ...
      - q: Kiểm tra của OONI Probe đo lường kiểm duyệt internet như thế nào?
        a: |
      ...
      - q: Tôi không chuyên về kỹ thuật. Vậy tôi có chạy OONI Probe được không?
        a: |
      ...
      - q: Tôi cho chạy OONI Probe xong. Tôi có nên gửi kết quả đến các bạn?
        a: |
      ...
      - q: Có nên chạy OONI Probe thường xuyên?
        a: |
      ...
      - q: Làm sao để chạy OONI Probe tự động?
        a: |
      ...
      - q: Kéo dài việc chạy OONI Probe đến khi nào?
        a: |
      ...
      - q: Tôi tìm thấy các trang web bị chặn. Làm sao để vượt thoát việc chặn đó?
        a: |
      ...
      - q: OONI Probe tìm thấy một middlebox trong mạng của tôi. Điều đó có nghĩa là tôi đang bị theo dõi?
        a: |
      ...
      - q: Tôi có thể đo lường kiểm duyệt internet ở một quốc gia nào đó từ xa được không?
        a: |
      ...
      - q: OONI Probe thâu thập những loại dữ liệu gì?
        a: |
          ...
          * **Dữ liệu đo lường mạng** (khác nhau tùy thuộc vào loại [kiểm tra](https://github.com/ooni/spec/tree/master/nettests) nào được thực hiện)
          ...
          Tìm hiểu thêm về cách thức xử lý dữ liệu của trong trang Chính Sách Dữ Liệu của OONI: [https://ooni.org/about/data-policy/](https://ooni.org/about/data-policy/)
      - q: Làm sao để chọn không gửi dữ liệu đo lường cho OONI?
        a: |
      ...
      - q: Chạy OONI Probe có những rủi ro gì?
        a: |
      ...
      - q: Làm sao để giảm thiểu rủi ro khi cho chạy OONI Probe?
        a: |
      ...
      - q: Chạy OONI Probe xuyên qua VPN được không?
        a: |
      ...
      - q: OONI có cung cấp tư vấn pháp lý?
        a: |
  ...
  - heading: Kiểm tra trang web
    items:
      - q: Các trang web nào sẽ được kiểm tra xem có bị kiểm duyệt?
        a: |
      ...
      - q: Tại sao OONI Probe dùng danh sách kiểm tra?
        a: |
          ...
          [Danh sách kiểm tra](https://github.com/citizenlab/test-lists/tree/master/lists) có các lợi điểm sau đây:
      ...
      - q: Tại sao ứng dụng di động OONI Probe không kiểm tra hết tất cả các trang trong danh sách?
        a: |
      ...
      - q: Làm sao để đổi thời lượng kiểm tra trong ứng dụng di động OONI Probe để có thể kiểm tra nhiều trang web hơn?
        a: |
      ...
      - q: Làm sao để tìm danh sách kiểm tra của quốc gia tôi?
        a: |
          ...
          Bạn tìm danh sách kiểm tra của quốc gia bạn bằng cách tìm [tập tin CSV với mã số quốc gia của bạn](https://github.com/citizenlab/test-lists/tree/master/lists).
      - q: Tại sao quốc gia của tôi không có danh sách kiểm tra?
        a: |
      ...
      - q: Ai quyết định trang web nào nằm trong danh sách kiểm tra?
        a: |
      ...
      - q: Làm thế nào để đề nghị thêm trang vào danh sách kiểm tra?
        a: |
      ...
      - q: Tôi không có tài khoản GitHub, nhưng muốn đề nghị URL để kiểm tra. Làm thế nào đây?
        a: |
      ...
      - q: Khác biệt gì giữa danh sách kiểm tra và danh sách bị chặn?
        a: |
      ...
      - q: Loại trang web nào được OONI Probe kiểm tra?
        a: |
      ...
      - q: Làm thế nào để chọn thể loại trang web để kiểm tra?
        a: |
      ...
      - q: Làm thế nào để chọn trang web để kiểm tra?
        a: |
          ...
          * [OONI Probe Desktop – để bàn](https://ooni.org/support/ooni-probe-desktop#testing-specific-website-categories)
      - q: Làm thế nào để kiểm tra một danh sách URL tôi tự chọn?
        a: |
  ...
  - heading: Dữ liệu của OONI
    items:
      - q: Dữ liệu của OONI là gì?
        a: |

          [Dữ liệu của OONI](https://ooni.org/data/) là các dữ liệu đo lường mạng thâu thập được qua [các kiểm tra của OONI Probe](https://github.com/ooni/spec/tree/master/nettests).
      - q: Tại sao OONI công bố dữ liệu?
        a: |
      ...
      - q: OONI công bố dữ liệu nơi đâu?
        a: |
      ...
      - q: Làm sao để diễn giải dữ liệu của OONI?
        a: |
      ...
      - q: Làm sao để lấy và phân tích dữ liệu của OONI?
        a: |
          ...
          * **OONI API.** Bạn có thể tải về toàn bộ dữ liệu đo lường của OONI dưới dạng JSON qua [OONI API](https://api.ooni.io/). Xin đọc [tài liệu](https://api.ooni.io/api/) của chúng tôi để biết cách truy vấn API.
  ...
  - heading: OONI Explorer
    items:
      - q: OONI Explorer là gì?
        a: |
      ...
      - q: Làm thế nào để dùng OONI Explorer đi tìm các trang web bị chặn?
        a: |
      ...
      - q: Làm thế nào để truy cập các dữ liệu đo lường?
        a: |
          ...
          ![đo lường của OONI](/faq/measurement.png)
      ...
      - q: Làm thế nào để dùng OONI Explorer đi tìm dữ liệu của OONI?
        a: |
      ...
      - q: Làm thế nào để tìm “chứng cớ kiểm duyệt internet” trong một đo lường?
        a: |
      ...
      - q: Làm thế nào để tìm các trang web bị chặn tại quốc gia của tôi?
        a: |
      ...
      - q: Làm thế nào để xem một trang web nào đó có bị chặn hay không?
        a: |
          ...
          Kết quả “Được xác nhận” chặn chỉ hiển thị khi nào nhà mạng ISP gửi ra trang chặn cho các trang được kiểm tra.
      - q: Tại sao tôi không tìm thấy kết quả cho một trang web nào đó?
        a: |
      ...
      - q: Làm sao để xem một trang web có bị chặn trong một thời điểm nào đó?
        a: |
          ...
          Kết quả “Được xác nhận” chặn chỉ hiển thị khi nào nhà mạng ISP gửi ra trang chặn cho các trang được kiểm tra.
      - q: Cụm từ “Được Xác Nhận” nghĩa là sao?
        a: |
      ...
      - q: Tôi biết có nhiều trang web khác bị chặn. Tại sao OONI Explorer lại không liệt kê các trang đó khi tôi chọn “Được xác nhận”?
        a: |
          ...
          * **Trang web được đề cập đến đã được OONI Probe kiểm tra ở quốc gia đó và trong mạng mà trang đó bị chặn (các đo lường liên hệ đã được công bố).** Kiểm duyệt internet có khác biệt từ mạng này qua mạng kia ngay trong cùng một quốc gia. Nếu một trang web không được kiểm tra trong một mạng mà sẽ chặn trang đó và nếu người dùng OONI Probe lại chọn không chia sẻ dữ liệu đo lường, thì chúng tôi không có thông tin xác đáng cho trang web đó.
          ...
          Trong lúc chúng tôi luôn cải thiện thuật toán suy nghiệm để phát hiện kiểm duyệt, những trường hợp này sẽ thay đổi theo thời gian. Để có thêm chi tiết kỹ thuật, xin xem mã nguồn tại [ooni/pipeline](https://github.com/ooni/pipeline).
      - q: Tại sao OONI xác nhận là có kiểm duyệt khi thấy một trang thông báo bị chặn?
        a: |
      ...
      - q: Tại sao OONI không xác nhận các trường hợp kiểm duyệt internet khác (ngoài những trang web bị chặn)?
        a: |
      ...
      - q: Cụm từ “Bất thường” nghĩa là sao?
        a: |
      ...
      - q: Tại sao OONI Explorer cho rằng một trang web hay một ứng dụng nào đó tôi truy cập được lại bị chặn tại quốc gia của tôi?
        a: |
      ...
      - q: Tại sao dương tính giả xảy ra?
        a: |
      ...
      - q: Làm sao để nhận ra tình trạng dương tính giả?
        a: |
      ...
      - q: Làm thế nào để xem kết quả từ các kiểm tra khác của OONI Probe?
        a: |
          ...
          Xin cẩn trọng khi diễn giải kết quả “bất thường”, vì có thể xảy ra tình trạng dương tính giả.
      - q: Tại sao quốc gia tôi không có các dữ liệu đo lường gần đây nhất trong OONI Explorer?
        a: |
