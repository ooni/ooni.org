...
sections:
  - heading: About OONI
    items:
      ...
      - q: Why measure internet censorship?
        a: |
      ...
      - q: What is OONI’s relationship with The Tor Project?
        a: |
      ...
      - q: "What is OONI's legal status?"
        a: |

          As of June 2023, OONI is a nonprofit organization registered in Rome, Italy.
  ...
  - heading: OONI Probe
    items:
      ...
      - q: My country doesn’t have censorship. Why run OONI Probe?
        a: |
      ...
      - q: How do OONI Probe tests measure internet censorship?
        a: |
      ...
      - q: I am not a techie. Can I run OONI Probe?
        a: |
      ...
      - q: I ran OONI Probe. Should I send you the results?
        a: |
      ...
      - q: How often should I run OONI Probe?
        a: |
      ...
      - q: How can I run OONI Probe automatically?
        a: |
      ...
      - q: For how long should I run OONI Probe?
        a: |
      ...
      - q: I found blocked websites. How can I circumvent their blocking?
        a: |
      ...
      - q: OONI Probe found a middlebox on my network. Does that mean I am under surveillance?
        a: |
      ...
      - q: Can I measure internet censorship remotely in another country?
        a: |
      ...
      - q: What types of data does OONI Probe collect?
        a: |
      ...
      - q: How can I opt-out from sending OONI measurements?
        a: |
      ...
      - q: What are the risks of running OONI Probe?
        a: |
      ...
      - q: How can I reduce the risks associated with running OONI Probe?
        a: |
          ...
          * **Opt-out from sharing any measurements.** Through the settings of
          ...
          your app).
      - q: Can I run OONI Probe over a VPN?
        a: |
      ...
      - q: Can OONI provide legal advice?
        a: |
  ...
  - heading: Testing websites
    items:
      - q: Which websites will I test for censorship with OONI Probe?
        a: |
      ...
      - q: Why doesn’t the OONI Probe mobile app test all of the websites in test lists?
        a: |
      ...
      - q: How can I change the testing duration in the OONI Probe mobile app to test more websites?
        a: |
      ...
      - q: How can I find my country’s test list?
        a: |
      ...
      - q: Why doesn’t my country have a test list?
        a: |
          ...
          for your country.
      - q: Who decides which websites are included in test lists?
        a: |
      ...
      - q: How can I contribute to test lists?
        a: |
      ...
      - q: I’m not a GitHub user, but I’d still like to submit URLs for testing. How can I do so?
        a: |
      ...
      - q: What is the difference between a test list and a blocklist?
        a: |
          ...
          only confirm it.
      - q: What types of websites will OONI Probe test?
        a: |
      ...
      - q: How can I choose which types of websites to test?
        a: |
      ...
      - q: How can I choose which websites to test?
        a: |
      ...
      - q: How can I test a custom list of URLs?
        a: |
  ...
  - heading: OONI data
    items:
      ...
      - q: Where does OONI publish data?
        a: |
          ...
          * **[OONI API](https://api.ooni.io/):** Download the raw data in
          JSON format
      - q: How can I interpret OONI data?
        a: |
      ...
      - q: How can I fetch and analyze OONI data?
        a: |
  ...
  - heading: OONI Explorer
    items:
      ...
      - q: How can I find blocked websites via OONI Explorer?
        a: |
          ...
          positives.
      - q: How can I access measurements?
        a: |
      ...
      - q: How can I find OONI data via OONI Explorer?
        a: |
          ...
          **download in JSON format**.
          ...
          was generated.
      - q: How can I find “evidence of internet censorship” in a measurement?
        a: |
          ...
          * Based on our current heuristics, we only confirm internet censorship
          ...
          engineer.
      - q: How can I find blocked websites in my country?
        a: |
      ...
      - q: How can I check if a specific website is blocked?
        a: |
          ...
          “Confirmed” blocked results will only appear if the tested ISPs served
          block pages for those specific websites.
      - q: Why can’t I find results for a specific website?
        a: |
          ...
          * **The domain has been mistyped.** If you mistype the domain (for
          ...
          HTTPS prefix).
      - q: How can I check the blocking of websites during a specific time period?
        a: |
          ...
          “Confirmed” blocked results will only appear if the tested ISPs served
          block pages for those specific websites.
      - q: What do you mean by “Confirmed”?
        a: |
          ...
          the world.
      - q: I know of many other websites that are blocked. Why doesn’t OONI Explorer show them when I select “confirmed”?
        a: |
      ...
      - q: Why does OONI confirm censorship when a block page is served?
        a: |
      ...
      - q: Why doesn’t OONI confirm other cases of internet censorship (beyond block pages)?
        a: |
      ...
      - q: What do you mean by “Anomalies”?
        a: |
          ...
          what is happening.
      - q: Why does OONI Explorer suggest that a site or app that I can access is blocked in my country?
        a: |
      ...
      - q: Why do false positives occur?
        a: |
      ...
      - q: How can I distinguish false positives?
        a: |
          ...
          false positive.
      - q: How can I check results from other OONI Probe tests?
        a: |
          ...
          Please interpret the “anomalous” results with caution, as they may
          contain false positives.
      - q: Why doesn’t my country have any recent measurements on OONI Explorer?
        a: |
