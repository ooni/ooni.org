...
sections:
  - heading: 
    items:
      ...
      - q: Vifaa vya kukwepa udhibiti wa mtandao
        a: |
      ...
      - q: Seva inayopokea maombi ya DNS
        a: |
      ...
      - q: OONI Probe
        a: |
          ...
          [Windows](https://ooni.org/install/) na
          [macOS](https://ooni.org/install/).
      - q: OONI Run
        a: |
      ...
      - q: Upotoshaji wa usafirishaji wa taarifa
        a: |
