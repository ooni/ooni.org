...
sections:
  - heading: Sobre OONI
    items:
      ...
      - q: ¿Por qué medir la censura en Internet?
        a: |
      ...
      - q: ¿Cuál es la relación de OONI con el Proyecto Tor?
        a: |
      ...
      - q: ¿Cuál es el estatus legal de la OONI?
        a: |
  ...
  - heading: OONI Probe
    items:
      ...
      - q: En mi país no hay censura. ¿Por qué utilizar OONI Probe?
        a: |
      ...
      - q: ¿Qué hacen los tests de OONI Probe?
        a: |
      ...
      - q: ¿Cómo miden los tests de OONI Probe la censura en Internet?
        a: |
      ...
      - q: No soy un experto en tecnología. ¿Puedo utilizar OONI Probe?
        a: |
      ...
      - q: ¿Cómo puedo ejecutar OONI Probe?
        a: |
      ...
      - q: He ejecutado OONI Probe. ¿Debo enviarles los resultados?
        a: |
      ...
      - q: ¿Con qué frecuencia debo ejecutar OONI Probe?
        a: |
      ...
      - q: ¿Cómo puedo ejecutar OONI Probe automáticamente?
        a: |
      ...
      - q: ¿Durante cuánto tiempo debo ejecutar OONI Probe?
        a: |
          ...
          tiempo posible (años).
      - q: He encontrado sitios web bloqueados. ¿Cómo puedo evitar su bloqueo?
        a: |
      ...
      - q: OONI Probe ha encontrado un middlebox en mi red. ¿Significa eso que estoy bajo vigilancia?
        a: |
      ...
      - q: ¿Puedo medir la censura en Internet de forma remota en otro país?
        a: |
      ...
      - q: ¿Qué tipo de datos recoge OONI Probe?
        a: |
      ...
      - q: ¿Cómo puedo cancelar el envío de mediciones de OONI?
        a: |
      ...
      - q: ¿Cuáles son los riesgos de ejecutar OONI Probe?
        a: |
      ...
      - q: ¿Cómo puedo reducir los riesgos asociados al uso de OONI Probe?
        a: |
      ...
      - q: ¿Puedo ejecutar OONI Probe a través de una VPN?
        a: |
      ...
      - q: ¿Puede OONI proporcionar asesoramiento legal?
        a: |
  ...
  - heading: Testeando sitios web
    items:
      - q: ¿Qué sitios web testeará en busca de censura con OONI Probe?
        a: |
      ...
      - q: ¿Por qué OONI Probe utiliza listas de test?
        a: |
      ...
      - q: ¿Por qué la aplicación móvil OONI Probe no testea todas las páginas web de las listas de test?
        a: |
      ...
      - q: ¿Cómo puedo cambiar la duración de los tests en la aplicación móvil OONI Probe para testear más sitios web?
        a: |
      ...
      - q: ¿Cómo puedo encontrar la lista de test de mi país?
        a: |
      ...
      - q: ¿Por qué mi país no tiene una lista de test?
        a: |
      ...
      - q: ¿Quién decide qué sitios web se incluyen en las listas de test?
        a: |
      ...
      - q: ¿Cómo puedo contribuir a las listas de test?
        a: |
      ...
      - q: No soy usuario de GitHub, pero me gustaría enviar URL para los tests. ¿Cómo puedo hacerlo?
        a: |
      ...
      - q: ¿Cuál es la diferencia entre una lista de test y una lista de bloqueo?
        a: |
      ...
      - q: ¿Qué tipos de sitios web puede testear OONI Probe?
        a: |
          ...
          los ISP).
      - q: ¿Cómo puedo elegir qué tipo de sitios web testear?
        a: |
      ...
      - q: ¿Cómo puedo elegir las páginas web que quiero testear?
        a: |
      ...
      - q: ¿Cómo puedo testear una lista personalizada de URLs?
        a: |
  ...
  - heading: Datos OONI
    items:
      ...
      - q: ¿Cómo puedo interpretar los datos OONI?
        a: |
      ...
      - q: ¿Cómo puedo obtener y analizar los datos OONI?
        a: |
  ...
  - heading: Explorador OONI
    items:
      - q: ¿Qué es OONI Explorer?
        a: |
      ...
      - q: ¿Cómo puedo encontrar sitios web bloqueados a través del Explorador de OONI?
        a: |
      ...
      - q: ¿Cómo puedo acceder a las mediciones?
        a: |
      ...
      - q: ¿Cómo puedo encontrar los datos de OONI a través del Explorador de OONI?
        a: |
      ...
      - q: "¿Cómo puedo encontrar \"tests de censura en Internet\" en una medición?"
        a: |
      ...
      - q: ¿Cómo puedo encontrar los sitios web bloqueados en mi país?
        a: |
      ...
      - q: ¿Cómo puedo comprobar si un sitio web específico está bloqueado?
        a: |
          ...
          * Haga clic en "**Filtrar resultados**".
          ...
          Los resultados bloqueados "Confirmados" sólo aparecerán si los ISP analizados devuelven páginas bloqueadas para esos sitios web específicos.
      - q: ¿Por qué no encuentro resultados para un sitio web específico?
        a: |
      ...
      - q: ¿Cómo puedo comprobar el bloqueo de sitios web durante un periodo de tiempo específico?
        a: |
      ...
      - q: "Sé de muchos otros sitios web que están bloqueados. ¿Por qué OONI Explorer no las muestra cuando selecciono \"Confirmado\"?"
        a: |
      ...
      - q: ¿Por qué OONI confirma la censura cuando se muestra una página bloqueada?
        a: |
      ...
      - q: ¿Por qué OONI no confirma otros casos de censura en Internet (más allá del bloqueo de páginas)?
        a: |
      ...
      - q: "¿A qué se refieren por \"anomalías\"?"
        a: |
      ...
      - q: ¿Por qué OONI Explorer sugiere que un sitio o aplicación al que puedo acceder está bloqueado en mi país?
        a: |
      ...
      - q: ¿Qué son los falsos positivos?
        a: |
      ...
      - q: ¿Por qué se producen falsos positivos?
        a: |
      ...
      - q: ¿Cómo puedo distinguir los falsos positivos?
        a: |
      ...
      - q: ¿Cómo puedo chequear los resultados de otras tests de OONI Probe?
        a: |
          ...
          * Haga clic en "**Filtrar resultados**".
          ...
          Por favor, interprete los resultados "Anómalos" con precaución, ya que pueden contener falsos positivos.
      - q: ¿Por qué mi país no tiene mediciones recientes en el Explorador de OONI?
        a: |
